...
#Set the color palette for graphing the PCA
...
ggplot(PCA_x, aes(x=PC1, y=PC2, color = color_pal)) + geom_point(size=5) + ylim(-175,125) + xlim(-100,500)
...
#Redefine the color palette, just in case
color_pal <- c("cyan","cyan","cyan",
           "#FCEADE","#FCEADE","#FCEADE",
           "#FF8A5B","#FF8A5B","#FF8A5B",
           "#EA526F","#EA526F","#EA526F",
...
ggplot(CB_PCA_x, aes(x=PC1, y=PC2, color = color_pal)) + geom_point(size=5) + ylim(-175,125) + xlim(-100,500)
...
ggplot(CB_PCA_x, aes(x=PC1, y=PC2, color = color_pal)) + geom_point(size = 5)
